...
const EditorContent = () => {
  ...
  const [templateStyles] = useState<TemplateStyle>(initialTemplateStyle);
  const [activeStep, setActiveStep] = useState(1);
  const [showFullPreview, setShowFullPreview] = useState(false);

  // Perbaikan tipe ref agar sesuai dengan ekspektasi TypeScript
        ...
        <div className="p-6 flex justify-between border-t">
          <div className="flex gap-3">
            ...
            {activeStep === STEPS.length && (
              <Button
                onClick={() =>
                  downloadPDF(fullCvRef as React.RefObject<HTMLDivElement>)
                }>
